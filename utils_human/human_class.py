...
class Human:
    ...
    def __init__(self, v_name='Ivan', v_date='01.01.2000'):
        self.name = v_name
        self.date_of_b = datetime.datetime.strptime(v_date, '%d.%m.%Y')
    ...
    def print_all_inf(self):
        return self.name + ' дата рождения: ' + str(self.date_of_b.strftime('%d.%m.%Y')) + ': ' + self.__rota + ' '+ self.__polk
